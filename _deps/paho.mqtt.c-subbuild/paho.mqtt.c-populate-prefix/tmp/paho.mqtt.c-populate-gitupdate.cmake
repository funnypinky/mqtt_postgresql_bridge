...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.3.11"
  WORKING_DIRECTORY "/home/office/source/cpp/mqtt_mongodb_bridge/_deps/paho.mqtt.c-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.3.11" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.3.11")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/office/source/cpp/mqtt_mongodb_bridge/_deps/paho.mqtt.c-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/office/source/cpp/mqtt_mongodb_bridge/_deps/paho.mqtt.c-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
